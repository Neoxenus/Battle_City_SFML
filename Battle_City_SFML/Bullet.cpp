...
void Bullet::draw(sf::RenderWindow& window)
{
	...
	sprite_all.setTextureRect(sf::IntRect(21 * constants::BLOCK_LENGHT + static_cast<int>(direction) * constants::BLOCK_LENGHT, 7 * constants::BLOCK_LENGHT, constants::BLOCK_LENGHT, constants::BLOCK_LENGHT));
